...
var HTMLCS = new function()
{
    ...
    */
     ...
     *
     * @param {String} standard The unique ID of the standard.
     *
     * @returns {Object}
     * @see this.addStandard
     */
    ...
    /**
     * Get a sniff by a standard and sniff code.
     *
     * @param {String} standard The unique ID of the standard.
     * @param {String} sniff    The dotted ID of the sniff, not including the standard name.
     * @param {Object} sniffObj The sniff object being added.
     *
     * @returns {Object}
     */
    ...
    /**
     * Includes a standard into the list of defined standards.
     *
     * @param {String} standard The unique ID of the standard.
     * @param {Object} stdObj   The standard object being added.
     */
    ...
    /**
     * Includes a sniff into the list of included sniffs.
     *
     * @param {String} standard The unique ID of the standard.
     * @param {String} sniff    The dotted ID of the sniff, not including the standard name.
     * @param {Object} sniffObj The sniff object being added.
...
HTMLCS.loc = {
     ...
     * @param {string} language     Set which translation to use
     * @see EasyEditLocalise#addLanguage
     */
    ...
    /**
     * Adds a language at runtime. This will attach a list of translation associated with a unique identifier.
     * @param {string} country_code     Unique identifier for the language, eg 'fr'. Can be 'french', or any other unique string
     * @param {string} description      Store a description for the language set
     * @param {object} translations     Object of key value pairs as an associative array (JSON format). Key = original, Value = translation
     * @see EasyEditLocalise@setLanguage
     */
    ...
    /**
     * Translate a string of text if there is a language equivalent
     *
     * @example
     * EasyEditLocalise._('A string to translate. A variable: %1',someVariable);
     * @param {string}  [toTranslate]     The string to translate
     * @param {string}  [keywordReplace...]  Any additional arguments added to this function will be replaced, no limit to the number of arguments
     */
    _: function()
    {
        var self = this;
    ...
    /**
     * Translate a string of text if there is a language equivalent, handling plurals.
     *
     * This is effectively the analogue of ngettext().
     *
     * @example
     * @param {String} singular Singular and key form.
     * @param {String} plural   Default plural form.
     * @param {Number} number   Number that determines the plural form.
     * @param {String} [keywordReplace...]  Any additional arguments added to this function will be replaced, no limit to the number of arguments
     */
    ...
    /**
     * Parse an array of arguments to replace in orginal text string
     * @private
     * @param {string} text     Orginal text string to search for replacements
     * @param {array} args      Array of additional arguments to replace
     * @returns {string} Re-parsed string
     */
    ...
    /**
     * Does a translation exist for a text string?
     * @param {string}  text        Search for string in translations
     * @returns {boolean}
     */
