...
var HTMLCS = new function()
{
    ...
    this.getStandard = function(standard) {
        var stdObj = window.HTMLCS.includedStandards[standard];

        if (!stdObj) {
            stdObj = window['HTMLCS_' + standard];
        }
    ...
    this.getSniff = function(standard, sniff) {
        var dummyRulesetFile = '/' + standard + '/ruleset.js';
        return _getSniff(dummyRulesetFile, sniff);
    };

    
    this.addStandard = function(standard, stdObj) {
        this.includedStandards[standard] = stdObj;
    };

    
    this.addSniff = function(standard, sniff, sniffObj) {
        this.includedSniffs[standard + '.' + sniff] = sniffObj;
    };

    
    var _getSniff = function(standard, sniff) {
        var parts   = standard.split('/');
        var stdName = parts[(parts.length - 2)];

        var sniffObj = window.HTMLCS.includedSniffs[stdName + '.' + sniff];
...
HTMLCS.loc = {
    ...
    // Set to country code to enable translated content
    language: null,

    // Store the translation strings
    translations: {},

    // Store the country code and text description
    availableLanguages: {},

    // Store any attempts at untranslated information
    storeUntranslatable: false,
    ...
    addLanguage: function(country_code,description,translations)
    {
        var self = this;
    ...
    _: function()
    {
        ...
        if (self.hasTranslation(args[0])) {
            // A translation is available
            return self._parseArgs(self.translations[self.language].strings[args[0]],args.slice(1));
        } else {
            // No translation available, just return the original text string
            if (self.storeUntranslatable) {
                self.translationsNotAvailable[args[0]] = self.language;
            }// End if
    ...
    _n: function(singular, plural, number)
    {
        var self = this;
        var args = Array.prototype.slice.call(arguments);
        if (self.hasTranslation(singular)) {
            // A translation is available
            // TODO: Handle the case for "multiple plural forms". At the moment,
            // presume normal singular and plural forms, with use of singular form
            // for both presumed when only one form is provided.
            var numForm = self.translations[self.language].plural(number);
            return self._parseArgs(self.translations[self.language].strings[singular][numForm],args.slice(3));
        } else {
            // No translation available, just return the original text string
            if (self.storeUntranslatable) {
                if (self.hasTranslation(singular) === false) {
                self.translationsNotAvailable[singular] = self.language;
                }

                if (self.hasTranslation(plural) === false) {
                self.translationsNotAvailable[plural] = self.language;
                }
            }// End if

            if (number === 1) {
                return self._parseArgs(singular,args.slice(3));
            } else {
    ...
    _parseArgs: function(text,args)
    {
        // Slightly modified idea from Dean Edwards base2 library
        if (args.length >= 1) {
            var pattern = new RegExp("%([1-" + args.length + "])", "g");
            return text.replace(pattern, function(match, index) {
                return args[index - 1];
            });
        }// End if
        return text;
    ...
    hasTranslation: function(text)
    {
        var self = this;
        return (self.language !== null &&
            typeof(self.translations[self.language]) !== "undefined" &&
...
HTMLCS.addStandard('WCAG2A', {
    name: 'WCAG 2.0 Single-A',
    description: HTMLCS.loc._(
        '<abbr title="%1">W3C</abbr> <a href="%2">Web Content Accessibility Guidelines (WCAG) 2.0</a>, checking level A Success Criteria only.',
    ...
    getMsgInfo: function(code) {
        return HTMLCS.getStandard('WCAG2AAA').getMsgInfo(code);
    }
});
...
HTMLCS.addSniff('WCAG2AAA', 'Principle3.Guideline3_3.3_3_2', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle3.Guideline3_2.3_2_3', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle3.Guideline3_2.3_2_5', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle3.Guideline3_1.3_1_2', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle3.Guideline3_1.3_1_6', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle3.Guideline3_1.3_1_4', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_4.2_4_2', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_4.2_4_4', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_4.2_4_1', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_4.2_4_3', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_4.2_4_7', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_3.2_3_1', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_1.2_1_1', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_2.2_2_4', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_2.2_2_3', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_2.2_2_5', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_2.2_2_2', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle2.Guideline2_2.2_2_1', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle4.Guideline4_1.4_1_1', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_2.1_2_5', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_2.1_2_8', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_2.1_2_4', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_2.1_2_1', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_2.1_2_3', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_4.1_4_2', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_4.1_4_3_F24', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_4.1_4_9', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_4.1_4_3', {
    ...
    {
        if (element === top) {
            var failures = HTMLCS.getSniff('WCAG2AAA', 'Principle1.Guideline1_4.1_4_3_Contrast').testContrastRatio(top, 4.5, 3.0);
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_4.1_4_6', {
    ...
    {
        if (element === top) {
            var failures = HTMLCS.getSniff('WCAG2AAA', 'Principle1.Guideline1_4.1_4_3_Contrast').testContrastRatio(top, 7.0, 4.5);
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_4.1_4_5', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_4.1_4_7', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_3.1_3_1_AAA', {
    _labelNames: null,
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_3.1_3_3', {
...
HTMLCS.addSniff('WCAG2AAA', 'Principle1.Guideline1_1.1_1_1', {
